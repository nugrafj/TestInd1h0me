...
WebUI.waitForElementPresent(findTestObject('Pages/Login/Lanjut'), GlobalVariable.Timeout)

if(WebUI.verifyElementNotClickable(findTestObject('Pages/Login/Lanjut'), FailureHandling.CONTINUE_ON_FAILURE) == true)
	 { 
