...
WebUI.setText(findTestObject('Pages/Login/Input ID Login'), 'wasdwasd')

WebUI.verifyElementText(findTestObject('Pages/Login/Invalid Email'), 'Mohon cantumkan nomor ponsel atau email yang aktif')
